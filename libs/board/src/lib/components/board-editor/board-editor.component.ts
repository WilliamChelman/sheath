...
import { heroBars3, heroMinus, heroPlus } from '@ng-icons/heroicons/outline';
...
@Component({
  ...
  viewProviders: [provideIcons({ heroPlus, heroMinus, heroBars3 })],
  template: `
    <div class="board-editor">
      ...
      <div class="board-toolbar flex flex-wrap gap-2 mb-4">
        <div class="join">
          ...
          >
            <ng-icon name="heroMinus" class="text-sm" />
            Column
          </button>
        </div>
        <div class="join">
              ...
              @if (getCellAt(position); as cell) {
                ...
                >
                  ...
                  <div class="relative h-full group">
                    ...
                    >
                      <ng-icon name="heroBars3" class="text-base-content/60" />
                    </div>
                    <lib-board-cell
                      [cell]="cell"
                      [readonly]="false"
