...
@Component({
  ...
  template: `
    <div class="obsidian-editor flex flex-col h-full min-h-[600px]">
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="join">
            <button
              ...
              title="Live Preview"
            >
              <ng-icon name="heroSquares2x2" class="text-lg" />
            </button>
            <button
              type="button"
              class="join-item btn btn-sm"
              ...
              title="Split View"
            >
              <ng-icon name="heroTableCells" class="text-lg" />
            </button>
          </div>
...
export class ObsidianEditorComponent implements OnInit {
