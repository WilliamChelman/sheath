...
@Component({
  ...
  template: `
    <label class="swap swap-rotate btn btn-ghost btn-sm btn-square" [title]="t('theme')">
      <input
        type="checkbox"
      ...
      />
      <ng-icon name="phosphorSun" class="swap-off text-lg" />
      <ng-icon name="phosphorMoon" class="swap-on text-lg" />
    </label>
  `,
})
