...
import { EntityInitializerService } from '../../../../apps/web-app/src/app/pages/compendium/services/entity-initializer.service';
    ...
    >
      <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-base-content/60 mb-4">{{ t('subtitle') }}</p>
...
export class CompendiumView implements OnInit, OnDestroy {
  ...
  private readonly entityInitializerService = inject(EntityInitializerService);
  ...
  ngOnInit(): void {
    ...
    this.entityInitializerService.init();
