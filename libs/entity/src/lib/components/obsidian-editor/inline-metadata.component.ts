...
import { heroPlus, heroTag, heroXMark } from '@ng-icons/heroicons/outline';
...
@Component({
  ...
  imports: [NgIcon],
  viewProviders: [provideIcons({ heroTag, heroXMark, heroPlus })],
  template: `
    <div class="inline-metadata p-6 border-b border-base-300">
      ...
      <div class="mt-4 flex flex-wrap items-center gap-2">
        ...
        @if (isAddingTag()) {
          ...
          >
            <ng-icon name="heroPlus" class="text-xs" />
          </button>
        }
      </div>
    </div>
